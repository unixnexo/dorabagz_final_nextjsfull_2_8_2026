    ...
    <main dir="rtl" className="min-h-screen bg-[#f1f2f3] text-[#171717]">
      ...
      >
        ...
        <FadeInSection delay={0}>
          ...
          <div className="overflow-hidden rounded-[28px] bg-brand-secondary">
        ...
        <FadeInSection delay={0.05} className="mt-6">
          ...
          <div className="rounded-[24px] bg-brand-secondary p-3">
        ...
        <FadeInSection delay={0.1} className="mt-6">
          ...
          <div className="space-y-3 rounded-[28px] bg-brand-secondary p-4">
            <Input
        ...
        <AnimatePresence>
          {courier && (
            ...
            >
              ...
              <div className="flex items-center gap-3 rounded-[24px] bg-brand-secondary p-4">
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 border-t border-black/[0.05] bg-[#f1f2f3]/90 px-4 pb-[calc(env(safe-area-inset-bottom)+20px)] pt-3 backdrop-blur-xl">
        <div className="mx-auto max-w-[500px]">
          ...
          <Button
            ...
            className="h-16 w-full rounded-[20px] bg-gradient-to-l from-brand-primary to-[#171717] text-[17px] font-bold shadow-[0_8px_24px_-6px_rgba(0,0,0,0.35)] transition-transform active:scale-[0.98] disabled:opacity-60"
          >
            {isSubmitting ? (
              "در حال ثبت سفارش..."
            ) : (
