...
import { AdminFabButton } from "@/components/admin/coupons/admin-fab-button";
import { CouponsList } from "@/components/admin/coupons/coupons-list";
import { CouponFormSheet } from "@/components/admin/coupons/coupon-form-sheet";
import { DeleteCouponDialog } from "@/components/admin/coupons/delete-coupon-dialog";
      ...
      <div className="flex items-center gap-2.5 pt-4">
        <div className="flex-1">
          <AdminSearchField
            ...
            placeholder="جستجو با کد تخفیف..."
          />
        </div>
        <AdminFabButton label="کد تخفیف جدید" onClick={openCreate} />
      </div>
