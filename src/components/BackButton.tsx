...
export default function BackButton({
    ...
    return (
        <button
            ...
            aria-label="بازگشت"
            className={cn(
                "z-50 flex size-11 items-center justify-center rounded-full border border-white/60 bg-white/50 text-black/65 shadow-[0_8px_30px_rgba(0,0,0,0.08)] backdrop-blur-xl transition-all duration-200 hover:bg-white/70 hover:text-black active:scale-90 active:bg-white/80",
